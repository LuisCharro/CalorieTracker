/**
 * Shared enums for FrontEnd-BackEnd contract alignment
 * These must match Backend enums exactly at /Users/luis/Repos/CalorieTracker_BackEnd/src/shared/enums.ts
 */
